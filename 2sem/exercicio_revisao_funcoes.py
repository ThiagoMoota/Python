'''
Escreva um programa em Python que simule o cálculo de notas de um aluno em diferentes disciplinas. O programa deve modular e utilizar estruturas de controle e funções.

1. Requisitos do sistemas
...
def calcular_media(notas):
    ...
    for nota in notas: #acessa cada um item da lista
